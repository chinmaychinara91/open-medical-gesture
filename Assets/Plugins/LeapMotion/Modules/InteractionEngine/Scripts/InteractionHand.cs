        ...
        private void refreshPrimaryHoverPoints()
        {
            for (int i = 0; i < enabledPrimaryHoverFingertips.Length; i++)
            {
                if (enabledPrimaryHoverFingertips[i])
                {
                    ...
                    // _fingertipTransforms[i].position
                    //if (device.m_DataProvider.GetNumOfHands() == 2)
                    //{
                    //    for (int ii = 0; ii < 2; i++)
                    //    {
                    //        if (device.m_DataProvider.hands[ii].isLeft)
                    //        {
                    //            _fingertipTransforms[i].position = device.m_DataProvider.GetTipPosition(ii, i);
                    //        }
                    //        if (device.m_DataProvider.hands[ii].isRight)
                    //        {
                    //            _fingertipTransforms[i].position = device.m_DataProvider.GetTipPosition(ii, i);
                    //        }
                    //    }
                    ...
                    //else
                    //{
                    //    _fingertipTransforms[i].position = device.m_DataProvider.GetTipPosition(0, i);
                    //}

                    //_fingertipTransforms[i].rotation
                    //if (device.m_DataProvider.GetNumOfHands() == 2)
                    //{
                    //    for (int ii = 0; ii < 2; i++)
                    //    {
                    //        if (device.m_DataProvider.hands[ii].isLeft)
                    //        {
                    //            _fingertipTransforms[i].rotation = device.m_DataProvider.GetJointRotation(ii, i, 3);
                    //        }
                    //        if (device.m_DataProvider.hands[ii].isRight)
                    //        {
                    //            _fingertipTransforms[i].rotation = device.m_DataProvider.GetJointRotation(ii, i, 3);
                    ...
                    //else
                    //{
                    //    _fingertipTransforms[i].rotation = device.m_DataProvider.GetJointRotation(0, i, 3);
                    //}
                }
                else
                {
