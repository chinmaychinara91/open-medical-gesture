...
public class SyringeBehaviour_100ui : SmartObjectBehaviour
{
    ...
    override public void AttachToHand()
    {
        ...
        if (touchFlag && (!rightHand.GetComponent<HasGrabbed>().hasObjectGrabbed))
        {
            ...
            else
            {
                ...
                transform.localPosition = new Vector3(-0.0001153478f, 0.002109845f, -3.321713e-05f);
                transform.localRotation = Quaternion.Euler(-85.784f, 66.496f, -162.379f);
            }
