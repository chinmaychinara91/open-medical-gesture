...
public class SyringeBehaviour_10ml : SmartObjectBehaviour
{
    ...
    override public void AttachToHand()
    {
        ...
        if (touchFlag && (!rightHand.GetComponent<HasGrabbed>().hasObjectGrabbed))
        {
            ...
            else
            {
                ...
                transform.localPosition = new Vector3(-0.00013f, 0.00199f, 4e-05f);
                transform.localRotation = Quaternion.Euler(-87.75401f, 114.082f, -4.398f);
            }
