...
public class SyringeBehaviour_2ml : SmartObjectBehaviour
{
    ...
    override public void AttachToHand()
    {
        ...
        if (touchFlag && (!rightHand.GetComponent<HasGrabbed>().hasObjectGrabbed))
        {
            ...
            else
            {
                ...
                transform.localPosition = new Vector3(-0.000122f, 0.00189f, -1.4e-05f);
                transform.localRotation = Quaternion.Euler(-3.922f, 287.263f, -90.39201f);
            }
