...
public class SyringeBehaviour_5ml : SmartObjectBehaviour
{
    ...
    override public void AttachToHand()
    {
        ...
        if (touchFlag && (!rightHand.GetComponent<HasGrabbed>().hasObjectGrabbed))
        {
            ...
            else
            {
                ...
                transform.localPosition = new Vector3(-0.000171f, 0.001908f, -6.4e-05f);
                transform.localRotation = Quaternion.Euler(-95.259f, -109.605f, 192.115f);
            }
