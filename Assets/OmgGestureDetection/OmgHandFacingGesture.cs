...
public class OmgHandFacingGesture : OmgGestureBase
{
    public EHand m_Hand;
    ...
    {
        OmgGestureDetectionManager.OmgDetectionHand detectionHand = OmgGestureDetectionManager.Get().GetHand(m_Hand);
